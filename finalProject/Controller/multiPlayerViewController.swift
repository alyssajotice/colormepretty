...
class multiPlayerViewController: UIViewController, UIScrollViewDelegate {
    ...
    @IBOutlet weak var canvasView: canvasViewMultiPlayer!
...
extension multiPlayerViewController : ColorServiceDelegate {
    ...
    func connectedDevicesChanged(manager: ColorService, connectedDevices: [String]) {
        OperationQueue.main.addOperation {
            ...
            if connectedDevices.count >= 2{
                self.deviceLabel.text = "Connections: " + connectedDevices[0] + ", " + connectedDevices[1]
            }
            else if connectedDevices.count == 1{
                self.deviceLabel.text = "Connections: " + connectedDevices[0]
                
            }
            else{
                self.deviceLabel.text = "Waiting for connection..."
            }
        }
    }
